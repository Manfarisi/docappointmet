...
const Banner = () => {
  ...
  return (
    <div className='flex bg-green-300 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      {/* left side */}
      <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>  
        <div className='text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-blue-800'>
          <p>Book Appointment</p>
          <p className='mt-4'> With 100+ Trustede Doctors</p>
        </div>
        ...
        <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'>
          <div className='w-full absolute bottom-0 right-0 max-w-md h-72 bg-white/70 rounded-lg' />
        </div>
    </div>
  )
}
