  ...
  return (
    <form className='min-h[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        <p className='text-3x2 font-extrabold'>{state === 'Sign Up' ? "Create Account" : "Login"}</p>
        ...
        <button className='bg-green-500 text-gray-50 w-full py-2 rounded-md text-base'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
        {
          state === 'Sign Up'
